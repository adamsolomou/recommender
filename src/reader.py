...
def fetch_data(train_size=1.0, n_users=10000, n_movies=1000, train_file='data_train.csv', test_file='sampleSubmission.csv', seed=42):    
    """
    ...
    if validation:
        dataloader = {'train': (train_users, train_movies, train_ratings, A_train), 
                      'valid': (valid_users, valid_movies, valid_ratings, A_valid), 
                      'test':  (test_users, test_movies)}
    else:
        dataloader = {'train': (train_users, train_movies, train_ratings, A_train), 
                      'valid': None, 
                      'test':  (test_users, test_movies)}
